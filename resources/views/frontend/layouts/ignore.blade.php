...
<head>
    ...
    <title>Sutra Accessories - Online Shopping for Electronics, Apparel, Computers, Books, DVDs & more</title>
    <!-- Standard Favicon -->
                            ...
                            <div class="brand-logo text-lg-center">
                                <a href="home.html">
                                    <img src={{ asset('frontend/images/main-logo/goodgoods-branding-1.png') }}
                                        alt="Sutra Accessories" class="app-brand-logo">
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="bottom-footer-wrapper">
                    ...
                    <p class="copyright-text">Copyright &copy; 2022
                        <a href="home.html">Sutra Accessories</a> All Right Reserved
                    </p>
                </div>
            </div>
            <!-- Bottom-Footer /- -->
            ...
            <div class="vertical-center">
                <div class="text-center">
                    ...
                    <span>Please enable JavaScript in your browser or upgrade to a JavaScript-capable browser to
                        register for Sutra Accessories.</span>
                </div>
            </div>
        </div>
        <style>
