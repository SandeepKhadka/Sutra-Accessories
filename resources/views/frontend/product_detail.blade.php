...
@section('title', 'Sutra Accessories - Product Detail')
@section('styles')
    <!--====== Vendor Css ======-->
                    ...
                    <div class="col-lg-2">
                        <div class="card w-100 mb-2" style="background-color: rgba(243, 243, 243, 0.5);">
                            <div class="card-body">
                                ...
                                <span
                                    class="card-text pd-detail__name mb-2">{{ \App\Models\Shop::where('user_id', @$product->vendor_id)->value('shop_name') ?? 'Sutra Accessories' }}</span>
